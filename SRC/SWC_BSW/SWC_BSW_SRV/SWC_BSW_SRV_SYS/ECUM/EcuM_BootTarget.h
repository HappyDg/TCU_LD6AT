 ...
 * ECUM_VAR_BOOTTARGET.  Note that in this case the memory section and class
 * must be available and defined in MemMap.h.  The linker file must map this
 * section to the same physical address for the appication and the bootlosder
 * part. */
...
#if (! defined(ECUM_VAR_BOOTTARGET))
#define ECUM_VAR_BOOTTARGET ECUM_VAR_NOINIT
#endif
...
/*==================[end of file]===========================================*/
#endif /* if !defined(ECUM_BOOTTARGET_H) */
