 ...
 ** wakeup validation but otherwise return without any action until this
 ** callback has been called. This is supposed to be done by BswM after it
 ** has finished the initialization procedure (after both startup or wakeup),
 ** including all deferred initialization tasks.
 **
