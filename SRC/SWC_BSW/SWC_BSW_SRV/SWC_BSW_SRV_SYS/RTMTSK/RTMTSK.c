...
/*                                                                            */
/* !File            : RTMTSK_.c                                               */
/* !Description     : APIs of RTMTSK_ Component                               */
/*                                                                            */
...
{
   TaskType localTaskId;
   uint32   u32LocalTaskDuration;

   (void)GetTaskID(&localTaskId);
   if ((localTaskId == RTMTSK_u8TaskId) || (localTaskId == RTMTSK_ku8TaskId))
   {
