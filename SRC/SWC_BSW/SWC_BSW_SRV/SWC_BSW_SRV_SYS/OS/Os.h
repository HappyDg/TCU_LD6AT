...
/* [MISRA 2004 Rule 19.7] */ /*lint -estring(961, CAT1_ISR ,CAT1_TRAP ,DECLARE_CAT1_ISR ,OS_MAIN ,OS_MFCR ,OS_MTCR ,OS_DISABLE ,OS_ENABLE ,OS_ISYNC ,OS_DSYNC ,OS_SYSCALL ,OS_NOP) */
#define OS_MAIN() extern int Os_main(void); int main(void) { OS_MTCR(0xfe04, 0x200 | (OS_MFCR(0xfe04))); /* Ensure PSW.IS */ return Os_main(); } int Os_main(void)  /* [$Satisfies $TgtCore 56] */
...
#define OSServiceId_Os_GetStackUsage ((OSServiceIdType)42)
#define OSServiceId_Os_GetISRMaxStackUsage ((OSServiceIdType)43)
#define OSServiceId_Os_GetTaskMaxStackUsage ((OSServiceIdType)44)
#define OSServiceId_Os_ResetISRMaxStackUsage ((OSServiceIdType)45)
#define OSServiceId_Os_ResetTaskMaxStackUsage ((OSServiceIdType)46)
#define OSServiceId_ReleaseResource ((OSServiceIdType)47)
#define OSServiceId_Restart ((OSServiceIdType)48)
#define OSServiceId_ResumeAllInterrupts ((OSServiceIdType)49)
#define OSServiceId_ResumeOSInterrupts ((OSServiceIdType)50)
#define OSServiceId_Schedule ((OSServiceIdType)51)
#define OSServiceId_SetEvent ((OSServiceIdType)52)
#define OSServiceId_SetAbsAlarm ((OSServiceIdType)53)
#define OSServiceId_SetRelAlarm ((OSServiceIdType)54)
#define OSServiceId_SetRestartPoint ((OSServiceIdType)55)
#define OSServiceId_ShutdownOS ((OSServiceIdType)56)
#define OSServiceId_StartOS ((OSServiceIdType)57)
#define OSServiceId_StartScheduleTableAbs ((OSServiceIdType)58)
#define OSServiceId_StartScheduleTableRel ((OSServiceIdType)59)
#define OSServiceId_StartScheduleTableSynchron ((OSServiceIdType)60)
#define OSServiceId_SyncScheduleTable ((OSServiceIdType)61)
#define OSServiceId_SyncScheduleTableRel ((OSServiceIdType)62)
#define OSServiceId_SetScheduleTableAsync ((OSServiceIdType)63)
#define OSServiceId_StopScheduleTable ((OSServiceIdType)64)
#define OSServiceId_SuspendAllInterrupts ((OSServiceIdType)65)
#define OSServiceId_SuspendOSInterrupts ((OSServiceIdType)66)
#define OSServiceId_TerminateApplication ((OSServiceIdType)67)
#define OSServiceId_TerminateTask ((OSServiceIdType)68)
#define OSServiceId_WaitEvent ((OSServiceIdType)69)
#define OSServiceId_AllowAccess ((OSServiceIdType)70)
#define OSServiceId_GetApplicationState ((OSServiceIdType)71)
...
#define OSError_ControlIdle_CoreID() ((CoreIdType)(Os_ErrorInformation.service_param1))
#define OSError_ControlIdle_IdleMode() ((IdleModeType)(Os_ErrorInformation.service_param2))
...
#include "MemMap.h" /* [MISRA 2004 Rule 19.15] */ /*lint !e537 !e451 */
/*lint -restore */
extern VAR(Os_ErrorInformationType, OS_VAR_NOINIT) Os_ErrorInformation/*-public_accessibility-*/;
...
extern VAR(Os_JumpBufType, OS_VAR_NOINIT) Os_RestartJumpBuf;
