...
/* RESETVECT should be defined in FBL_INTF_Cfg.h */
extern void RESETVECT( void );

#define FBL_APPLVECT_START_SEC_CONST
#include "MemMap.h"
const V_MEMROM0 V_MEMROM1 vuint32 V_MEMROM2 const volatile ApplIntJmpTable[] = {(vuint32)RESETVECT, APPLVECT_FROM_APPL};
