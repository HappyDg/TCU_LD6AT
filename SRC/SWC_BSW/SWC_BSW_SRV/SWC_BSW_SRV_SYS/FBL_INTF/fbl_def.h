 ...
 *  02.46.00   2015-03-06  QPs     ESCAN00081042    Use fbl_mtab.h on Renault SLP5
 *  02.47.00   2015-03-13  Rie     ESCAN00081579    MMC SLP7: Use fbl_mtab.h
 *  02.48.00   2015-04-16  HRf     ESCAN00082470    Add support for XC2000 and Keil compiler for tExportFct
 *  02.49.00   2015-04-16  CB      ESCAN00082486    Reworked FBL_CLIENT_DC switches
 **********************************************************************************************************************/
...
/* Access macros for FblHeader GENy version elements for application */
#  define GetFblGenyVersion0()   (FblHeaderTable->FblGenyVersion0)
#  define GetFblGenyVersion1()   (FblHeaderTable->FblGenyVersion1)
#  define GetFblGenyVersion2()   (FblHeaderTable->FblGenyVersion2)
#  define GetFblGenyVersion3()   (FblHeaderTable->FblGenyVersion3)
#  define GetFblGenyVersion4()   (FblHeaderTable->FblGenyVersion4)
#  define GetFblGenyVersion5()   (FblHeaderTable->FblGenyVersion5)
#  define GetFblGenyVersion6()   (FblHeaderTable->FblGenyVersion6)
#  define GetFblGenyVersion7()   (FblHeaderTable->FblGenyVersion7)
#  define GetFblGenyVersion8()   (FblHeaderTable->FblGenyVersion8)
#  define GetFblGenyVersion9()   (FblHeaderTable->FblGenyVersion9)
...
/* Function access macros for FBL header structure */
#  define ApplSecComputeKey(a, b, c)      (*((pSecComputeKeyFct)FblHeaderTable->pSecComputeKeyFct))(a, b, c)
#  define ApplSecComputeCRC(a)            (*((pSecComputeCRCFct)FblHeaderTable->pSecComputeCRCFct))(a)
#  define ApplSecVerifySignatureFct(a)    (*((pSecVerifySignatureFct)FblHeaderTable->pSecVerifySignatureFct))(a)
#  define ApplSecInitDecryption(a)        (*((pSecInitDecryptionFct)FblHeaderTable->pSecInitDecyptionFct))(a)
#  define ApplSecDecryption(a, b, c)      (*((pSecDecryptionFct)FblHeaderTable->pSecDecryptionFct))(a, b, c)
#  define ApplSecDeinitDecryption(a)      (*((pSecDeinitDecryptionFct)FblHeaderTable->pSecDeinitDecryptionFct))(a)
#  define ApplSecGenerateSeed(a)          (*((pSecGenerateSeedFct)FblHeaderTable->pSecGenerateSeedFct))(a)

/* Compare key function interface changed with HIS Security Module specification 1.0.2 */
#  if defined( SECM_HIS_SECURITY_MODULE_VERSION )
/* ESCAN00046553: Version check split */
#   if ( SECM_HIS_SECURITY_MODULE_VERSION >= 0x010002u )
#    define ApplSecCompareKey(a, b)       (*((pSecCompareKeyFct)FblHeaderTable->pSecCompareKeyFct))(a, b)
#    define ApplSecCompareKeyFct(a, b)    (*((pSecCompareKeyFct)FblHeaderTable->pSecCompareKeyFct))(a, b)
#   endif /* SECM_HIS_SECURITY_MODULE_VERSION >= 0x010002u */
#  endif /* SECM_HIS_SECURITY_MODULE_VERSION */
#  if defined( ApplSecCompareKey )
#  else
/* !defined( SECM_HIS_SECURITY_MODULE_VERSION ) || (SECM_HIS_SECURITY_MODULE_VERSION < 0x010002u) */
#   define ApplSecCompareKey(a)           (*((pSecCompareKeyFct)FblHeaderTable->pSecCompareKeyFct))(a)
#   define ApplSecCompareKeyFct(a)        (*((pSecCompareKeyFct)FblHeaderTable->pSecCompareKeyFct))(a)
#  endif

#  define ApplSecInitVerificationFct(a)   (*((pSecInitVerificationFct)FblHeaderTable->pSecInitVerificationFct))(a)
#  define ApplSecVerificationFct(a)       (*((pSecVerificationFct)FblHeaderTable->pSecVerificationFct))(a)
#  define ApplSecDeinitVerificationFct(a) (*((pSecDeinitVerificationFct)FblHeaderTable->pSecDeinitVerificationFct))(a)
#  define ApplSecTaskFct()                (*((pSecTaskFct)FblHeaderTable->pSecTaskFct))
...
#   define kEepFblXcpProgram     0x5Bu
#  endif
...
typedef struct tagFblHeader
{
   ...
   vuint8    FblGenyVersion0;
   vuint8    FblGenyVersion1;
   vuint8    FblGenyVersion2;
   vuint8    FblGenyVersion3;
   vuint8    FblGenyVersion4;
   vuint8    FblGenyVersion5;
   vuint8    FblGenyVersion6;
   vuint8    FblGenyVersion7;
   vuint8    FblGenyVersion8;
   vuint8    FblGenyVersion9;
   vuint8    FblHeaderAlign1;            /**< Alignment to even addresses */
   /* FBL export functions */
   tExportFct  pSecGenerateSeedFct;
   tExportFct  pSecCompareKeyFct;
   tExportFct  pSecComputeKeyFct;
   tExportFct  pSecComputeCRCFct;
...
#   endif
#  else
#   error "Error in FBL_DEF.H: SEC_SECURITY_CLASS not defined."
#  endif
#  if defined( SEC_ENABLE_DECRYPTION )
   tExportFct  pSecInitDecryptionFct;
   tExportFct  pSecDecryptionFct;
   tExportFct  pSecDeinitDecryptionFct;
#  endif
   tExportFct  pSecInitVerificationFct;
   tExportFct  pSecVerificationFct;
   tExportFct  pSecDeinitVerificationFct;
