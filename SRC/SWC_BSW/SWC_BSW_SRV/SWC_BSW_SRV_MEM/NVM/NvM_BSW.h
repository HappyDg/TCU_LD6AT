...
/** \cond documentation 
 ** Exclude this part from the documentation because 
 ** NVM_REQ_REDUNDANCY_FAILED, NVM_REQ_RESTORED_FROM_ROM and NVM_REQ_CANCELED
...
#if (defined(NVM_DOXY_FLAG) || ((!defined(NVM_INTERNAL_USE)) || (NVM_INCLUDE_RTE == STD_OFF)))
