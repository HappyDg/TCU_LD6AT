...
(
   ...
   const PduR_ProvRxBufFpType ProvideRxBufferFp,
   const PduR_TpRxIndFpType RxIndicationFp,
...
(
   ...
   const PduR_ProvTxBufFpType ProvideTxBufferFp,
...
(
   PduIdType TxPduId,
   NotifResultType Result,
   const PduR_TpTxConfFpType TxConfirmationFp,
   P2VAR(PduR_WrapASR32TxSessionInfoType, AUTOMATIC, PDUR_APPL_DATA) TxSessionInfoPtr
)
{
