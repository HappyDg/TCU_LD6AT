...
FUNC(void, CCP_USR_CODE) CCP_vidUsrIni(void)
{
   ...
   //CCPUSR_u32ActivePageAddr = OVC_u32GetPhysPage((uint32 *)CCPUSR_DFLT_CALIB_PAGE_ADDR);
   CCPUSR_u32ActivePageAddr = (uint32 *)CCPUSR_DFLT_CALIB_PAGE_ADDR;
}
...
FUNC(void, CCP_USR_CODE) CCP_vidMainFunction(void)
{
   ...
   if (CCPUSR_u32ActivePageAddr != CCPUSR_DFLT_CALIB_PAGE_ADDR)
   {
