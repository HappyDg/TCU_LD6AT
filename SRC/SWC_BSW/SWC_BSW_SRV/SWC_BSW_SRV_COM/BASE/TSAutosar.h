 ...
 *
 * Reason:
 * This is actually a false positive, since the respective rule explicitly
 * states "... unless it is used as the operand of # or ##." which is
...
#define TS_GetBit(Address,Bit,OpType,Result)         \
  ((Result) = (OpType) (((OpType)(*(Address) & ((OpType)((OpType)1U<<(Bit))))) >> (Bit)))
