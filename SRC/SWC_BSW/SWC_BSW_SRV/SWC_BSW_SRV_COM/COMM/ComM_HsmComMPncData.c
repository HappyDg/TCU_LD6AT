...
#define COMM_HSM_COMMPNC_NUM_EVENTS 5U
...
STATIC CONST(ComM_HsmActionIdxType, COMM_CONST)
  ComM_HsmTrPncPrepareSleepSteps3[1] =
{
...
},
{
  ...
  COMM_HSM_COMMPNC_GIDX_PNCNOCOM_GUARD_2, /* guard idx */
  COMM_HSM_COMMPNC_SIDX_PNCPREPARESLEEP /* target state */
},
{
