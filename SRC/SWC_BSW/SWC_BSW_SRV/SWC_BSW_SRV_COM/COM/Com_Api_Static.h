 ...
 * The module calling the function Com_Init has to include Com_PBcfg.h. The
 * invocation of the Com_Init function is
 ...
 * \return Result of operation
 * \param[in] SignalGroupArrayLength - reference to length of the signal group array
