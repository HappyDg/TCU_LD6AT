...
#if (defined COM_STORAGE_DIRECT)        /* To prevent double declaration */
#error COM_STORAGE_DIRECT already defined
#endif /* #if (defined COM_STORAGE_DIRECT) */

/** \brief Define COM_STORAGE_DIRECT */
#define COM_STORAGE_DIRECT 0U

#if (defined COM_STORAGE_REFERENCE)     /* To prevent double declaration */
#error COM_STORAGE_REFERENCE already defined
#endif /* #if (defined COM_STORAGE_REFERENCE) */

/** \brief Define COM_STORAGE_REFERENCE */
#define COM_STORAGE_REFERENCE 1U
...
#if (defined COM_SIZE_8_BYTES)       /* To prevent double declaration */
#error COM_SIZE_8_BYTES already defined
#endif /* #if (defined COM_SIZE_8_BYTES) */

/** \brief Define COM_SIZE_8_BYTES */
#define COM_SIZE_8_BYTES 1U

#if (defined COM_SIZE_32_BYTES)      /* To prevent double declaration */
#error COM_SIZE_32_BYTES already defined
#endif /* #if (defined COM_SIZE_32_BYTES) */

/** \brief Define COM_SIZE_32_BYTES */
#define COM_SIZE_32_BYTES 2U

#if (defined COM_SIZE_254_BYTES)     /* To prevent double declaration */
#error COM_SIZE_254_BYTES already defined
#endif /* #if (defined COM_SIZE_254_BYTES) */

/** \brief Define COM_SIZE_254_BYTES */
#define COM_SIZE_254_BYTES 3U
...
#if (defined COM_TRANSFER_PPROPERTY_TRIG_OC)  /* To prevent double declaration */
#error COM_TRANSFER_PPROPERTY_TRIG_OC already defined
#endif /* if (defined COM_TRANSFER_PPROPERTY_TRIG_OC) */

/** \brief Define COM_TRANSFER_PPROPERTY_TRIG_OC (COM_TRANSFER_PPROPERTY_TRIGGER_ON_CHANGE) */
#define COM_TRANSFER_PPROPERTY_TRIG_OC 2U
