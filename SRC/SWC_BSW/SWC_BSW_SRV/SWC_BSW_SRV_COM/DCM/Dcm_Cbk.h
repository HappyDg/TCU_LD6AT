...
extern FUNC(void, DCM_CODE) Dcm_TpRxIndication(PduIdType DcmRxPduId, NotifResultType Result);
 ...
 ** \retval BUFREQ_E_NOT_OK Data has not been copied. Requestfailed, in case the corresponding I-PDU
 ** was stopped. */
 ...
 ** transmission of the DCM I-PDU. This enables unlocking of the transmit buffer and error handling.
 **
