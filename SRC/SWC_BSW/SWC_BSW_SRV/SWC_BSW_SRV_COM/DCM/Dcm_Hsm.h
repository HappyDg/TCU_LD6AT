...
typedef struct Dcm_HsmStateStruct Dcm_HsmStateType;

/** \brief State chart description data
 *
 * This struct is placed in ROM */
struct Dcm_HsmStatechartStruct
{
   ...
   * RAM */
  P2VAR(Dcm_HsmInstType, TYPEDEF, DCM_VAR_NOINIT)   instances;
  ...
  P2VAR(Dcm_HsmEventType, TYPEDEF, DCM_VAR_NOINIT)  events;
...
typedef struct Dcm_HsmStatechartStruct Dcm_HsmStatechartType;
