...
#if ( WDG_17_SCU_SW_MINOR_VERSION != 2U )
...
void Wdg_17_Scu_Init(const Wdg_17_Scu_ConfigType* ConfigPtr)
{
   ...
   /*(WDG_DEV_ERROR_DETECT == STD_ON)*/
  {
    ...
    if(Wdg_kConfigPtr->WdgSafetyProperty[CoreId] == 1U)
    {
      ...
      Wdg_lSafetyInit(Wdg_kConfigPtr, PasswordInit); 
...
**                                                                            **
** Syntax           : static Std_ReturnType Wdg_lChangeMode(WdgIf_ModeType Mode)
**                                                                            **
**                    [/cover]                                                **
**                                                                            **
** Service ID       : None                                                    **
...
static Std_ReturnType Wdg_lChangeMode(WdgIf_ModeType Mode)
{
  ...
  if (Mode == WDGIF_OFF_MODE)
  {
    ...
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to efficiently
    write the WDT disable bit into WDTCON1 SFR register */
