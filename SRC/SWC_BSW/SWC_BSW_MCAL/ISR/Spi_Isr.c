...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI1_ERR_ISR)                                 */
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI0_PT_ISR)                                  */
/* !Description : Service for Phase transition interrupt (PT2) used by QSPI0  */
/*                                                                            */
/* !LastAuthor  : L. Baglin                                                   */
/******************************************************************************/
#if ((SPI_QSPI0_USED == STD_ON) && (SPI_LEVEL_DELIVERED != 0))
#ifdef SRC_QSPI_QSPI0_PT_ISR
ISR(SRC_QSPI_QSPI0_PT_ISR)
{
   /* Call QSPI0 Interrupt funtion */
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI1_PT_ISR)                                  */
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI2_PT_ISR)                                  */
/* !Description : Service for Phase transition interrupt (PT2) used by QSPI2  */
/*                                                                            */
/* !LastAuthor  : L. Baglin                                                   */
/******************************************************************************/
#if ((SPI_QSPI2_USED == STD_ON) && (SPI_LEVEL_DELIVERED != 0))
#ifdef SRC_QSPI_QSPI2_PT_ISR
ISR(SRC_QSPI_QSPI2_PT_ISR)
{
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI3_PT_ISR)                                  */
/* !Description : Service for Phase transition interrupt (PT2) used by QSPI3  */
/*                                                                            */
/* !LastAuthor  : L. Baglin                                                   */
/******************************************************************************/
#if ((SPI_QSPI3_USED == STD_ON) && (SPI_LEVEL_DELIVERED != 0))
#ifdef SRC_QSPI_QSPI3_PT_ISR
ISR(SRC_QSPI_QSPI3_PT_ISR)
{
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI0_U_ISR)                                   */
/* !Description : Service for User interrupt (PT1) used by QSPI0              */
/*                                                                            */
/* !LastAuthor  : L. Baglin                                                   */
/******************************************************************************/
#if ((SPI_QSPI0_USED == STD_ON) && (SPI_LEVEL_DELIVERED != 0))
#ifdef SRC_QSPI_QSPI0_U_ISR
ISR(SRC_QSPI_QSPI0_U_ISR)
{
   /* Call QSPI3 Interrupt funtion */
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI1_U_ISR)                                   */
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI2_U_ISR)                                   */
/* !Description : Service for User interrupt (PT1) used by QSPI2              */
/*                                                                            */
/* !LastAuthor  : L. Baglin                                                   */
/******************************************************************************/
#if ((SPI_QSPI2_USED == STD_ON) && (SPI_LEVEL_DELIVERED != 0))
#ifdef SRC_QSPI_QSPI2_U_ISR
ISR(SRC_QSPI_QSPI2_U_ISR)
{
   /* Call QSPI3 Interrupt funtion */
...
/******************************************************************************/
/* !FuncName    : ISR(SRC_QSPI_QSPI3_U_ISR)                                   */
/* !Description : Service for User interrupt (PT1) used by QSPI3              */
/*                                                                            */
/* !LastAuthor  : L. Baglin                                                   */
/******************************************************************************/
#if ((SPI_QSPI3_USED == STD_ON) && (SPI_LEVEL_DELIVERED != 0))
#ifdef SRC_QSPI_QSPI3_U_ISR
ISR(SRC_QSPI_QSPI3_U_ISR)
{
   /* Call QSPI3 Interrupt funtion */
