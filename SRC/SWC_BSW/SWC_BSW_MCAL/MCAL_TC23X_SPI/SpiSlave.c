...
static void Spi_lSlaveStartChannel(uint32 Module, Spi_ChannelType Channel,
       uint32 DelayAndHwChNo, uint8 ParityConfig);
...
static void Spi_lSlaveHwSetChannelConfig(volatile uint32 Module,
                uint16 DataConfig,uint32 DelayAndHwChNo, uint8 ParityConfig);
...
IFX_LOCAL_INLINE void Spi_lSlaveWriteTransmit(void);
...
void Spi_lSlaveInit(const Spi_ConfigType* ConfigPtr)
{
  ...
  **  ------------------------------------------------------------------ */
  ...
  /*IFX_MISRA_RULE_17_04_STATUS="SPI_HW_MODULE" Pointer arithmetic is used to
    efficiently access the SFRs of multiple QSPI Modules.*/
  SPI_HW_MODULE[SPI_SLAVE_MODULE_INDEX].KRST0.U = SPI_KERNEL_RESET_VALUE;

  /*IFX_MISRA_RULE_11_05_STATUS="SPI_HW_MODULE" attempt to cast away volatile in
    terms of pointer access.*/
  /*IFX_MISRA_RULE_17_04_STATUS="SPI_HW_MODULE" Pointer arithmetic is used to
    efficiently access the SFRs of multiple QSPI Modules.*/
  ReadBack = SPI_HW_MODULE[SPI_SLAVE_MODULE_INDEX].KRST0.U;
  UNUSED_PARAMETER(ReadBack)
  ...
  /*IFX_MISRA_RULE_17_04_STATUS="SPI_HW_MODULE" Pointer arithmetic is used to
    efficiently access the SFRs of multiple QSPI Modules.*/
  SPI_HW_MODULE[SPI_SLAVE_MODULE_INDEX].KRST1.U = SPI_KERNEL_RESET_VALUE;

  /*IFX_MISRA_RULE_11_05_STATUS="SPI_HW_MODULE" attempt to cast away volatile in
    terms of pointer access.*/
  /*IFX_MISRA_RULE_17_04_STATUS="SPI_HW_MODULE" Pointer arithmetic is used to
    efficiently access the SFRs of multiple QSPI Modules.*/
  ReadBack = SPI_HW_MODULE[SPI_SLAVE_MODULE_INDEX].KRST1.U;
  UNUSED_PARAMETER(ReadBack)
  ...
  do
  {
    ...
    #else
    /*IFX_MISRA_RULE_11_05_STATUS="SPI_HW_MODULE" attempt to
      cast away volatile in terms of pointer access.*/
...
/*IFX_MISRA_RULE_17_04_STATUS="SPI_HW_MODULE" Pointer arithmetic is used to
    efficiently access the SFRs of multiple QSPI Modules.*/
  SPI_HW_MODULE[SPI_SLAVE_MODULE_INDEX].KRSTCLR.U = SPI_KERNEL_RESET_VALUE;
  /*IFX_MISRA_RULE_11_05_STATUS="SPI_HW_MODULE" attempt to
    cast away volatile in terms of pointer access.*/
/*IFX_MISRA_RULE_17_04_STATUS="SPI_HW_MODULE" Pointer arithmetic is used to
    efficiently access the SFRs of multiple QSPI Modules.*/
  ReadBack = SPI_HW_MODULE[SPI_SLAVE_MODULE_INDEX].KRSTCLR.U;
...
void Spi_lSlaveDeInit(void)
{
  ...
  **  ------------------------------------------------------------------ */
  ...
  {
    ModulePtr->ECON[HwChnlIdx].U = SLAVE_QSPI_ECON_RSTVAL;
  }
...
static void Spi_lSlaveHwDmaInit(void)
{
  ...
  MODULE_DMA.CH[DmaChannel].ADICR.U = SPI_DMA_RESET_VALUE;
  MODULE_DMA.CH[DmaChannel].CHCSR.U = SPI_DMA_RESET_VALUE;
  MODULE_DMA.TSR[DmaChannel].U = SPI_DMA_RESET_VALUE;
  MODULE_DMA.CH[DmaChannel].SADR.U = SPI_DMA_RESET_VALUE;
  MODULE_DMA.CH[DmaChannel].CHCFGR.U = SPI_DMA_RESET_VALUE;
  MODULE_DMA.CH[DmaChannel].DADR.U = SPI_DMA_RESET_VALUE;
...
static void Spi_lSlaveStartJob(uint32 Module, Spi_JobType JobId)
{
  ...
  */
  Spi_lSlaveHwSetJobConfig(ModulePtr, JobConfigPtr);
  ...
  Spi_lSlaveStartChannel(Module, Channel, DelayAndHwChNo, 
                                      ((uint8)(JobConfigPtr->ParitySelection)));
}
