 ...
 *
 * This API initialize the PLL with ramp steps, BUS dividers for the configuration
...
/** \brief API to get Cpu frequency.
 *
...
/** \brief API to get FSI divider frequency.
 *
 * This API returns the fFsi frequency based on the divider value in CCUCON register and the input oscillator.
 *
 ...
 *
 * This API returns the fFsi2 based on the divider value in CCUCON register and the input oscillator.
 *
 ...
 *
 * \return Frequency out of the SRI divider
 *
 */
 ...
 * This API returns the based on the divider value in CCUCON register and the input oscillator.
 *
 * \return Frequency out of the SPB divider
 *
 */
IFX_EXTERN float32 IfxScuCcu_getSpbFrequency (void);

IFX_EXTERN float32 IfxScuCcu_setSpbFrequency (float32 frequency);

IFX_EXTERN uint32 IfxScuCcu_calculateFDR (float32 moduleFreq, float32 * realModuleFreq);
 ...
 */
IFX_EXTERN float32 IfxScuCcu_getModuleFrequency (uint32 fdrU);
