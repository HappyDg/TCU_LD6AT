...
IFX_LOCAL_INLINE uint32 IfxStm_getLower (Ifx_STM * stm);
IFX_LOCAL_INLINE uint32 IfxStm_getOffsetTimer (Ifx_STM * stm, uint8 offset);
IFX_LOCAL_INLINE uint32 IfxStm_getOffset4Timer (Ifx_STM * stm);
IFX_LOCAL_INLINE uint32 IfxStm_getOffset8Timer (Ifx_STM * stm);
IFX_LOCAL_INLINE uint32 IfxStm_getOffset12Timer (Ifx_STM * stm);
IFX_LOCAL_INLINE uint32 IfxStm_getOffset16Timer (Ifx_STM * stm);
IFX_LOCAL_INLINE uint32 IfxStm_getOffset20Timer (Ifx_STM * stm);
IFX_LOCAL_INLINE uint32 IfxStm_getOffset32Timer (Ifx_STM * stm);
/** \} */
...
IFX_LOCAL_INLINE void IfxStm_updateCompare (Ifx_STM * stm, IfxStm_Comparator comparator, uint32 ticks);
IFX_LOCAL_INLINE uint32 IfxStm_getCompare (Ifx_STM * stm, IfxStm_Comparator comparator);
/** \} */

/** \name Other functions
 * \{ */
IFX_EXTERN IfxStm_ResourceStm IfxStm_getIndex (Ifx_STM * stm);
IFX_LOCAL_INLINE void IfxStm_enableOcdsSuspend (Ifx_STM * stm);
/** \} */
 ...
 */
IFX_LOCAL_INLINE uint64 IfxStm_get (Ifx_STM * stm)
{
    uint64 result;
    result = stm->TIM0.U;
 ...
 * \param comparator selection comparator
 */
IFX_LOCAL_INLINE void IfxStm_increaseCompare (Ifx_STM * stm, IfxStm_Comparator comparator, uint32 ticks)
{
 ...
 *
 */
IFX_LOCAL_INLINE void IfxStm_waitTicks (Ifx_STM * stm, uint32 ticks)
{
    uint32 beginTime;
