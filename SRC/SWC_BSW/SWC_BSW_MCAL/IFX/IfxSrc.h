 ...
 * \return none.
 */
IFX_LOCAL_INLINE void IfxSrc_disable (volatile Ifx_SRC_SRCR * src)
{
    src->B.SRE = 0;
}
 ...
 * \return none.
 */
IFX_LOCAL_INLINE void IfxSrc_enable (volatile Ifx_SRC_SRCR * src)
{
    src->B.SRE = 1;
}
 ...
 * \return none.
 */
IFX_LOCAL_INLINE void IfxSrc_clearRequest (volatile Ifx_SRC_SRCR * src)
{
    src->B.CLRR = 1;
}
 ...
 * \return none.
 */
IFX_LOCAL_INLINE void IfxSrc_setRequest (volatile Ifx_SRC_SRCR * src)
{
    src->B.SETR = 1;
}
 ...
 * \return none.
 */
IFX_LOCAL_INLINE void IfxSrc_init (volatile Ifx_SRC_SRCR * src, IfxSrc_Tos typOfService, uint16 priority)
{
    src->B.SRPN = priority;
...
IFX_LOCAL_INLINE void IfxSrc_deinit (volatile Ifx_SRC_SRCR * src)
{
    src->U = 0;
}
