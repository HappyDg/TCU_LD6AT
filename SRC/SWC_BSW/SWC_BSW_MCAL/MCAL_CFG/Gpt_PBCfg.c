...
*/
/* GPT_0 channel notification function declaration */
extern void MAIN_vidGptNotification(void);
...
static const Gpt_ChannelConfigType Gpt_kChannelConfig0[ ] =
{
  ...
  /* Channel Symbolic Name(ChannelId) : GPT_0 
     GTM TOM/ATOM Channel : GTM_TOM0_CHANNEL15 in GPT_MODE_CONTINUOUS
  */ 
  {
    #if (GPT_ENABLE_DISABLE_NOTIFICATION_API == STD_ON)
    &MAIN_vidGptNotification, /* Notification Function */
    #endif
