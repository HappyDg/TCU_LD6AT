...
#define IFX_LOCAL_INLINE                  static inline   //__attribute__((always_inline))
#endif
...
/** Jump and link
 */
IFX_LOCAL_INLINE void __jump_and_link(void (*fun)(void))
{
 ...
 */
IFX_LOCAL_INLINE int __max(int a, int b)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __maxs(short a, short b)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE unsigned __maxu(unsigned a, unsigned b)
{
    unsigned res;
 ...
 */
IFX_LOCAL_INLINE int __min(int a, int b)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE short __mins(short a, short b)
{
    short res;
 ...
 */
IFX_LOCAL_INLINE unsigned __minu(unsigned a, unsigned b)
{
    unsigned res;
 ...
 */
IFX_LOCAL_INLINE short __clssf(sfract a)
{
    short res;
 ...
 */
IFX_LOCAL_INLINE float __fract_to_float(fract a)
{
    float res;
 ...
 */
IFX_LOCAL_INLINE fract __float_to_fract(float a)
{
    fract res;
 ...
 */
IFX_LOCAL_INLINE fract __getfract(laccum a)
{
    fract res;
 ...
 */
IFX_LOCAL_INLINE sfract __mac_r_sf(sfract a, sfract b, sfract c)
{
    sfract res;
 ...
 */
IFX_LOCAL_INLINE sfract __mac_sf(sfract a, sfract b, sfract c)
{
    sfract res;
 ...
 */
IFX_LOCAL_INLINE long __mulfractfract(fract a, fract b)
{
    long res;
 ...
 */
IFX_LOCAL_INLINE long __mulfractlong(fract a, long b)
{
    long res;
    __asm__ volatile ("mul.q %0,%1,%2,1":"=d"(res):"d"(a), "d"(b):"memory");
    return res;
 ...
 */
IFX_LOCAL_INLINE sfract __round16(fract a)
{
    sfract res;
 ...
 */
IFX_LOCAL_INLINE sfract __s16_to_sfract(short a)
{
    sfract res;
 ...
 */
IFX_LOCAL_INLINE short __sfract_to_s16(sfract a)
{
    signed short res;
    __asm__ volatile ("sh  %0,%1,-16":"=d"(res):"d"(a):"memory");
    return res;
 ...
 */
IFX_LOCAL_INLINE unsigned short __sfract_to_u16(sfract a)
{
    unsigned short res;
    __asm__ volatile ("sh  %0,%1,-16":"=d"(res):"d"(a):"memory");
    return res;
 ...
 */
IFX_LOCAL_INLINE laccum __shaaccum(laccum a, int b)
{
    laccum res;
 ...
 */
IFX_LOCAL_INLINE fract __shafracts(fract a, int b)
{
    fract res;
 ...
 */
IFX_LOCAL_INLINE sfract __shasfracts(sfract a, int b)
{
    sfract res;
    __asm__ volatile ("shas  %0,%1,%2":"=d"(res):"d"(a), "d"(b):"memory");
    return res;
 ...
 */
IFX_LOCAL_INLINE sfract __u16_to_sfract(unsigned short a)
{
    sfract res;
    __asm__ volatile ("sh  %0,%1,16":"=d"(res):"d"(a):"memory");
    return res;
 ...
 */
IFX_LOCAL_INLINE int __extr(int a, unsigned p, unsigned w)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __ins(int trg, const int trgbit, int src, const int srcbit)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __insert(int a, int b, int p, const int w)
{ // dbg	because bugged
    int res;
 ...
 */
IFX_LOCAL_INLINE int __insn(int trg, const int trgbit, int src, const int srcbit)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __disable_and_save(void)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE void __restore(int ie)
{
 ...
 */
IFX_LOCAL_INLINE void __cacheawi(unsigned char* p)
{
    __asm__ volatile("cachea.wi [%0]0"::"a"(p));
}
/**  Write back and invalidate cache index "p". Generates CACHEI.WI [Ab].
 */
IFX_LOCAL_INLINE void __cacheiwi(unsigned char* p)
{
 ...
 */
IFX_LOCAL_INLINE unsigned char* __cacheawi_bo_post_inc(unsigned char* p)
{
    __asm__ volatile("cachea.wi  [%0+]0"::"a"(p));
    return p;
}
 ...
 */
IFX_LOCAL_INLINE int __mulsc(int a, int b, int offset)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE unsigned __rol(unsigned operand, unsigned int count)
{
    unsigned res;
 ...
 */
IFX_LOCAL_INLINE unsigned __ror(unsigned operand, unsigned int count)
{
    unsigned res;
 ...
 */
IFX_LOCAL_INLINE __packb __absb(__packb a)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __packhw __absh(__packhw a)
{
    __packhw res;
 ...
 */
IFX_LOCAL_INLINE __packhw __abssh(__packhw a)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE char __extractbyte1(__packb a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE char __extractbyte2(__packb a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE char __extractbyte3(__packb a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE char __extractbyte4(__packb a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE short __extracthw1(__packhw a)
{
    short res;
 ...
 */
IFX_LOCAL_INLINE short __extracthw2(__packhw a)
{
    short res;
 ...
 */
IFX_LOCAL_INLINE unsigned char __extractubyte1(__upackb a)
{
    unsigned char res;
    __asm__ volatile ("extr  %0,%1,0,8"
                      :"=d"(res):"d"(a):"memory");
 ...
 */
IFX_LOCAL_INLINE unsigned char __extractubyte2(__upackb a)
{
    unsigned char res;
    __asm__ volatile ("extr  %0,%1,8,8"
                      :"=d"(res):"d"(a):"memory");
 ...
 */
IFX_LOCAL_INLINE unsigned char __extractubyte3(__upackb a)
{
    unsigned char res;
    __asm__ volatile ("extr  %0,%1,16,8"
                      :"=d"(res):"d"(a):"memory");
 ...
 */
IFX_LOCAL_INLINE unsigned char __extractubyte4(__upackb a)
{
    unsigned char res;
    __asm__ volatile ("extr  %0,%1,24,8"
                      :"=d"(res):"d"(a):"memory");
 ...
 */
IFX_LOCAL_INLINE unsigned short __extractuhw1(__upackhw a)
{
    unsigned short res;
    __asm__ volatile ("extr  %0,%1,0,16"
                      :"=d"(res):"d"(a):"memory");
 ...
 */
IFX_LOCAL_INLINE unsigned short __extractuhw2(__upackhw a)
{
    unsigned short res;
    __asm__ volatile ("extr  %0,%1,16,16"
                      :"=d"(res):"d"(a):"memory");
...
/**  Extract first byte from a __packb
 */
IFX_LOCAL_INLINE char __getbyte1(__packb* a)
{
    char res;
...
/**  Extract second byte from a __packb
 */
IFX_LOCAL_INLINE char __getbyte2(__packb* a)
{
    char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,8,8"
...
/**  Extract third byte from a __packb
 */
IFX_LOCAL_INLINE char __getbyte3(__packb* a)
{
    char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,16,8"
...
/**  Extract fourth byte from a __packb
 */
IFX_LOCAL_INLINE char __getbyte4(__packb* a)
{
    char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,24,8"
...
/**  Extract first short from a __packhw
 */
IFX_LOCAL_INLINE short __gethw1(__packhw* a)
{
    short res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,0,16"
...
/**  Extract second short from a __packhw
 */
IFX_LOCAL_INLINE short __gethw2(__packhw* a)
{
    short res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,16,16"
...
/**  Extract first unsigned byte from a __packb
 */
IFX_LOCAL_INLINE unsigned char __getubyte1(__upackb* a)
{
    unsigned char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,0,8"
...
/**  Extract second unsigned byte from a __packb
 */
IFX_LOCAL_INLINE unsigned char __getubyte2(__upackb* a)
{
    unsigned char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,8,8"
...
/**  Extract third unsigned byte from a __packb
 */
IFX_LOCAL_INLINE unsigned char __getubyte3(__upackb* a)
{
    unsigned char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,16,8"
...
/**  Extract fourth unsigned byte from a __packb
 */
IFX_LOCAL_INLINE unsigned char __getubyte4(__upackb* a)
{
    unsigned char res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,24,8"
...
/**  Extract first unsigned short from a __packhw
 */
IFX_LOCAL_INLINE unsigned short __getuhw1(__upackhw* a)
{
    unsigned short res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,0,16"
...
/**  Extract second unsigned short from a __packhw
 */
IFX_LOCAL_INLINE unsigned short __getuhw2(__upackhw* a)
{
    unsigned short res;
    __asm__ volatile ("ld.w  %0,[%1]0 \n\
                     extr  %0,%0,16,16"
 ...
 */
IFX_LOCAL_INLINE __packb __initpackb(int a, int b, int c, int d)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __packb __initpackbl(long a)
{
    return (__packb) a;
}
 ...
 */
IFX_LOCAL_INLINE __packhw __initpackhw(short a, short b)
{
    __packhw res;
 ...
 */
IFX_LOCAL_INLINE __packhw __initpackhwl(long a)
{
    return a;
}
 ...
 */
IFX_LOCAL_INLINE __upackb    __initupackb( unsigned a, unsigned b, unsigned c, unsigned d)
{
    __upackb res;
    __asm__ volatile ("insert  %3,%3,%4,8,8   \n\
                    insert  %1,%1,%2,8,8   \n\
 ...
 */
IFX_LOCAL_INLINE __upackhw    __initupackhw( unsigned short a, unsigned short b)
{
    __upackhw res;
    __asm__ volatile ("insert  %0,%1,%2,16,16"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __packb __insertbyte1(__packb a, char b)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __packb __insertbyte2(__packb a, char b)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __packb __insertbyte3(__packb a, char b)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __packb __insertbyte4(__packb a, char b)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __upackb    __insertubyte1( __upackb a, unsigned char b)
{
    __upackb res;
    __asm__ volatile ("insert  %0,%1,%2,0,8"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __upackb    __insertubyte2( __upackb a, unsigned char b)
{
    __upackb res;
    __asm__ volatile ("insert  %0,%1,%2,8,8"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __upackb     __insertubyte3( __upackb a, unsigned char b)
{
    __upackb res;
    __asm__ volatile ("insert  %0,%1,%2,16,8"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __upackb     __insertubyte4( __upackb a, unsigned char b)
{
    __upackb res;
    __asm__ volatile ("insert  %0,%1,%2,24,8"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __packhw __inserthw1(__packhw a, short b)
{
    __packhw res;
 ...
 */
IFX_LOCAL_INLINE __packhw __inserthw2(__packhw a, short b)
{
    __packhw res;
    __asm__ volatile ("insert  %0,%1,%2,16,16"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __upackhw    __insertuhw1( __upackhw a, unsigned short b)
{
    __upackhw res;
    __asm__ volatile ("insert  %0,%1,%2,0,16"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __upackhw    __insertuhw2( __upackhw a, unsigned short b)
{
    __upackhw res;
    __asm__ volatile ("insert  %0,%1,%2,16,16"
                      :"=d"(res):"d"(a), "d"(b):"memory");
 ...
 */
IFX_LOCAL_INLINE __packb __minb(__packb a, __packb b)
{
    __packb res;
 ...
 */
IFX_LOCAL_INLINE __upackb     __minbu( __upackb  a, __upackb  b)
{
    __upackb res;
 ...
 */
IFX_LOCAL_INLINE __packhw __minh(__packhw a, __packhw b)
{
    __packhw res;
 ...
 */
IFX_LOCAL_INLINE __upackhw    __minhu( __upackhw a, __upackhw b)
{
    __upackhw res;
...
/**  Insert char into first byte of a __packb
 */
IFX_LOCAL_INLINE void __setbyte1(__packb* a, char b)
{
...
/**  Insert char into second byte of a __packb
 */
IFX_LOCAL_INLINE void __setbyte2(__packb* a, char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
...
/**  Insert char into third byte of a __packb
 */
IFX_LOCAL_INLINE void __setbyte3(__packb* a, char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
...
/**  Insert char into fourth byte of a __packb
 */
IFX_LOCAL_INLINE void __setbyte4(__packb* a, char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
...
/**  Insert short into first halfword of a __packhw
 */
IFX_LOCAL_INLINE void __sethw1(__packhw* a, short b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
...
/**  Insert short into second halfword of a __packhw
 */
IFX_LOCAL_INLINE void __sethw2(__packhw* a, short b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
 ...
 */
IFX_LOCAL_INLINE void __setubyte1(__upackb* a, unsigned char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
                    insert  %%d15,%%d15,%1,0,8 \n\
                    st.w [%0],%%d15"
 ...
 */
IFX_LOCAL_INLINE void __setubyte2(__upackb* a, unsigned char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
                    insert  %%d15,%%d15,%1,8,8 \n\
                    st.w [%0],%%d15"
 ...
 */
IFX_LOCAL_INLINE void __setubyte3(__upackb* a, unsigned char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
                    insert  %%d15,%%d15,%1,16,8 \n\
                    st.w [%0],%%d15"
 ...
 */
IFX_LOCAL_INLINE void __setubyte4(__upackb* a, unsigned char b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
                    insert  %%d15,%%d15,%1,24,8 \n\
                    st.w [%0],%%d15"
...
/**  Insert unsigned short into first halfword of a __upackhw
 */
IFX_LOCAL_INLINE void __setuhw1(__upackhw* a, unsigned short b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
                    insert  %%d15,%%d15,%1,0,16 \n\
                    st.w [%0],%%d15"
...
/**  Insert unsigned short into second halfword of a __upackhw
 */
IFX_LOCAL_INLINE void __setuhw2(__upackhw* a, unsigned short b)
{
    __asm__ volatile ("ld.w  %%d15,[%0] \n\
                    insert  %%d15,%%d15,%1,16,16 \n\
                    st.w [%0],%%d15"
 ...
 */
IFX_LOCAL_INLINE int __absdif(int a, int b)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __abss(int a)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __clo(int a)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE int __cls(int a)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE double __fabs(double d)
{
    double res;
 ...
 */
IFX_LOCAL_INLINE float __fabsf(float f)
{
    float res;
...
/**  Return parity
 */
IFX_LOCAL_INLINE int __parity(int a)
{
    double res;
 ...
 */
IFX_LOCAL_INLINE char __satb(int a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE unsigned char __satbu(int a)
{
    unsigned char res;
 ...
 */
IFX_LOCAL_INLINE short __sath(int a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE unsigned short __sathu(int a)
{
    char res;
 ...
 */
IFX_LOCAL_INLINE int __adds(int a, int b)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE unsigned __addsu(unsigned a, unsigned b)
{
    unsigned res;
 ...
 */
IFX_LOCAL_INLINE int __subs(int a, int b)
{
    int res;
 ...
 */
IFX_LOCAL_INLINE unsigned __subsu(unsigned a, unsigned b)
{
    unsigned res;
 ...
 */
IFX_LOCAL_INLINE void __debug(void)
{
 ...
 */
IFX_LOCAL_INLINE void __dsync(void)
{
 ...
 */
IFX_LOCAL_INLINE void __isync(void)
{
 ...
 */
IFX_LOCAL_INLINE void __ldmst(volatile unsigned* address, unsigned mask, unsigned value)
{
 ...
 */
IFX_LOCAL_INLINE void __nop(void)
{
 ...
 */
IFX_LOCAL_INLINE void __nops(void* cnt)
{
 ...
 */
IFX_LOCAL_INLINE void __rslcx(void)
{
 ...
 */
IFX_LOCAL_INLINE void __svlcx(void)
{
 ...
 */
IFX_LOCAL_INLINE unsigned __swap(unsigned* place, unsigned value)
{
    unsigned res;
...
IFX_LOCAL_INLINE void __stopPerfCounters(void)
{
